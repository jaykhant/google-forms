...
const ResponseSubmit = ({
    ...
    validationSchema, updateAnswerInResponse, uploadFile, createResponse, isLoadingForSubmitResponse
}) => {
                    ...
                    <Stack>
                        <Flex justifyContent='space-between' align='center'>
                            <Button colorScheme='teal' variant='solid' isLoading={isLoadingForSubmitResponse} onClick={handleSubmit(() => {
                                createResponse({formId,response})
                            })}>Submit</Button>
...
function mapDispatchToProps(dispatch) {
    return ({
        ...
        createResponse: ({ formId, response }) => {
            dispatch({ type: ResponseViewActionTypes.createResponse, formId, response })
        }
    })
}
